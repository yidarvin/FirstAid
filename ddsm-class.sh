...
python train_CNNclassification.py --pTrain $path_train --pVal $path_val --pLog $path_log --name $name --nGPU 4 --bs 128 --ep 1000 --nClass 2 --do 1.0 --lr 0.001 --net GoogLe --l1 0.001
